...
def run(args, data, current_time, fold, device):
    ...
    if args.submode == 'clean':
        ...
        disadv_gp_pos_df = disadv_gp_pos_df.sample(n=int(args.ratio * len(disadv_gp_pos_df)), replace=False,
                                                   random_state=args.seed)
        adv_gp_neg_df = adv_gp_neg_df.sample(n=int(args.ratio * len(adv_gp_neg_df)), replace=False,
                                             random_state=args.seed)
